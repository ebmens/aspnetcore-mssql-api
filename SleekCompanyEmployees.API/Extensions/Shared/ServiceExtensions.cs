...
public static class ServiceExtensions
{
    ...
    services.AddDbContextFactory<RepositoryContext>(opts =>
    {
        ...
        {
            o.MigrationsAssembly("SleekCompanyEmployees.API");// b => b.MigrationsAssembly("SleekCompanyEmployees.API")
            o.EnableRetryOnFailure(maxRetryCount: 10, maxRetryDelay: TimeSpan.FromSeconds(30),
